...
var viewportSize = __webpack_require__(14); //https://github.com/jarvys/viewportSize
    ...
    _createClass(LazyResponsiveImages, [{
        ...
        value: function lazyLoadInit(className) {
            ...
            if (this._lazyLoad == null) {
                //These images are a always in the view port. SO we need to only load them when their scrolling container is in/near viewport
                //See: https://github.com/verlok/lazyload#lazy-lazyload
                var lazyLoadInstances = [];
                // The "lazyLazy" instance of lazyload is used (kinda improperly)
                // to check when the .horzContainer divs enter the viewport
                var lazyLazy = new LazyLoad({
                    elements_selector: ".tm-bg--underlay-wrap",
                    // When the .horzContainer div enters the viewport...
                    callback_set: function callback_set(el) {
                        // ...instantiate a new LazyLoad on it
                        var oneLL = new LazyLoad({
                            container: el,
                            elements_selector: '.bgimg1',
                            data_src: 'src'
                        });
                ...
                //set up normal imgaes with lazy load
                ...
                var imagesToLazyLoad = document.querySelectorAll('div:not(.tm-bg--underlay-wrap) img[data-src-lazy]');
                console.log(imagesToLazyLoad);
                for (var i = 0; i < imagesToLazyLoad.length; i++) {
                    //add extra class to help identify as lazy
                    imagesToLazyLoad[i].className += 'lazy';
                }
